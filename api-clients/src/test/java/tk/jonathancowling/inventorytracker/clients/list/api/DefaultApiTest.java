package tk.jonathancowling.inventorytracker.clients.list.api;
...
public class DefaultApiTest {
    ...
    public void listDeleteTest() {
        String item = null;
        // Item response = api.listDelete(item);
    ...
    public void listPostTest() {
        ...
        // Item response = api.listPost(itemPrototype);
    ...
    public void listPutTest() {
        ...
        // Item response = api.listPut(partialItem);
